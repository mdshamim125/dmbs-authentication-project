...
const Login = () => {
  ...
  const handleGoogleSignIn = () => {
    //create user with google singIn
    signInWithGoogle()
      .then((result) => {
  ...
  const handleForgetPassword = () => {
    ...
    if (!email) {
      toast.error("write  your address...");
      return;
  ...
  return (
    <div className="w-full max-w-sm mt-6 p-6 m-auto mx-auto bg-white rounded-lg shadow-md dark:bg-gray-800">
